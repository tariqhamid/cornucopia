...
$recv(aStream)._print_(self["@rating"]);
return self;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
var $1;
return $recv($recv(self._all())._asOrderedCollection())._sort_((function(a,b){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
return $recv($1).__lt($recv(b)._brand());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
var $1;
return $recv(self._allAphabeticalByBrand())._select_((function(e){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx2) {
//>>excludeEnd("ctx");
$1=$recv($recv(e)._brand())._asLowercase();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["asLowercase"]=1;
//>>excludeEnd("ctx");
return $recv($1)._beginsWith_($recv(aString)._asLowercase());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
